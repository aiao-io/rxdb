...
export function TreeMenuLazyPage() {
  ...
  const store = useTreeMenuLazyStore(rxdb, menuLargeTreeSource);
  const {
  ...
  const handleSave = useCallback(
    ...
    [editingTitles, menuRepository, store, renameWithPathGuard, visibleMenus]
  );
          ...
          <div className='mx-auto flex max-w-4xl flex-col gap-3'>
            ...
            <div className='flex items-center justify-between'>
              <div className='flex items-center gap-3'>
                <h1 className='text-2xl font-bold'>Tree Menu - Lazy Load</h1>
                ...
                {store.selectedParentId && (
                  <div className='join-item bg-base-200 border-base-300 flex items-center border border-r-0 px-3 text-sm'>
                    ...
                    <span className='max-w-[8rem] truncate font-medium'>
                      {store.getNode(store.selectedParentId)?.title}
                    </span>
                    <button
        ...
        <div className='flex-1 p-4'>
          ...
          >
            ...
            : rowVirtualizer.getVirtualItems().map(virtualRow => {
                const { menu, level, isExpanded, hasChildren, isLoading } = store.treeNodes[virtualRow.index];
                  ...
                  >
                    ...
                    : <span
                        className={`flex-1 cursor-pointer truncate text-sm ${
                          store.searchKeyword && menu.title.toLowerCase().includes(store.searchKeyword.toLowerCase()) ?
        ...
        <dialog className='modal modal-open'>
          <div className='modal-box'>
            ...
            <div className='py-4'>
              ...
              {store.deleteImpact && store.deleteImpact.childrenCount > 0 && (
...
export default TreeMenuLazyPage;
