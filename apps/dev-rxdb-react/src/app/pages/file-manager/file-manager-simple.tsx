...
export function FileManagerSimplePage() {
  const rxdb = useRxDB();
          ...
          <div className='mx-auto flex max-w-4xl flex-col gap-3'>
            ...
            <div className='flex items-center justify-between'>
              <div className='flex items-center gap-3'>
                <h1 className='text-2xl font-bold'>File Manager - Simple</h1>
                {store.searchKeyword ?
                ...
                <div className='dropdown dropdown-end'>
                  ...
                  <ul tabIndex={0} className='dropdown-content menu bg-base-100 rounded-box z-[1] w-52 p-2 shadow'>
                    {batchAddOptions.map(option => (
                      <li key={option.count}>
                        <button
                          data-testid={`file-batch-option-${option.count}`}
                          disabled={loadingActions.has('add_many')}
                          onClick={() => handleAddMany(option.count, 'add_many')}
                        >
                          {loadingActions.has('add_many') && (
        ...
        <div className='flex-1 overflow-auto p-4'>
          <div className='mx-auto max-w-4xl'>
            ...
            : <div className='space-y-0.5'>
                {store.treeNodes.map(({ file, level, isExpanded, hasChildren, isMatched }) => {
...
export default FileManagerSimplePage;
