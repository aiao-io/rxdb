...
describe('useFilePathValidator', () => {
  it('应该检测到文件名冲突', () => {
    ...
    const allNodes: FilePathNode[] = [
      { id: '1', name: 'test', extension: 'txt', parentId: null },
      { id: '2', name: 'other', extension: 'md', parentId: null }
    ];
  ...
  it('应该检测到文件夹名冲突', () => {
    ...
    const allNodes: FilePathNode[] = [{ id: '1', name: 'Documents', extension: null, parentId: null }];
  ...
  it('应该在不同父节点下允许同名', () => {
    ...
    const allNodes: FilePathNode[] = [
      { id: '1', name: 'folder1', extension: null, parentId: null },
      { id: '2', name: 'test', extension: 'txt', parentId: '1' }
    ];
  ...
  it('应该忽略当前节点（重命名场景）', () => {
    ...
    const allNodes: FilePathNode[] = [{ id: '1', name: 'test', extension: 'txt', parentId: null }];
  ...
  it('应该构建正确的文件路径', () => {
    ...
    const allNodes: FilePathNode[] = [
      { id: '1', name: 'Documents', extension: null, parentId: null },
      { id: '2', name: 'Projects', extension: null, parentId: '1' },
      { id: '3', name: 'README', extension: 'md', parentId: '2' }
    ];
