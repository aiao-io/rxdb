...
import { File, FileArchive, FileAudio, FileCode, FileImage, FileText, FileVideo, Folder } from '@lucide/vue';
...
export function getFileIcon(entry: StorageBrowserItem): Component {
