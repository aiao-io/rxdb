        ...
        <div class="mx-auto flex max-w-4xl flex-col gap-3">
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
              <h1 class="text-2xl font-bold">File Manager - Virtual</h1>
              <div
            ...
            >
              <div
                ...
                :class="[
                  ...
                  dragDrop.highlightedMenuIds.value.has(node.file.id) && 'bg-warning/20',
              ...
              >
                ...
                >
                  <template v-if="node.file.type === 'folder' && node.hasChildren">
                    <ChevronDown
