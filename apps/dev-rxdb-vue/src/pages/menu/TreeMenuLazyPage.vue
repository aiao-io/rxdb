...
const store = useTreeMenuLazyStore(rxdb);
const selectedParent = computed(() => {
  const selectedParentId = store.selectedParentId.value;
  return store.loadedNodes.value.find(menu => menu.id === selectedParentId);
});
        ...
        <div class="mx-auto flex max-w-4xl flex-col gap-3">
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
              <h1 class="text-2xl font-bold"> Tree Menu - Lazy Load </h1>
              <div
                class="badge badge-primary"
                data-testid="menu-count"
              >
                {{ store.treeNodes.value.length }} 项
              </div>
              <!-- 批量添加 -->
          ...
          <template v-else>
            ...
            >
              ...
              <button
                ...
                :disabled="!node.hasChildren || node.isLoading"
              ...
              >
                <span
                  ...
                  v-if="node.isLoading"
                />
                <template v-else-if="node.hasChildren">
                  <ChevronDown
