    ...
    [
      'classic',
      {
        docs: {
          ...
          // 请更改为您的仓库
          // 删除此项可移除"编辑此页面"链接
          editUrl: 'https://github.com/aiao-io/aiao/tree/main/website/',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/aiao-io/aiao',
          position: 'right',
    ...
    footer: {
      links: [
        ...
        },
        {
          title: '社区',
          items: [
            { label: 'GitHub', href: 'https://github.com/aiao-io/aiao' },
            { label: '更新日志', href: 'https://github.com/aiao-io/aiao/blob/main/CHANGELOG.md' },
            { label: '贡献指南', href: 'https://github.com/aiao-io/aiao/blob/main/CONTRIBUTING.md' }
          ]
        }
      ],
