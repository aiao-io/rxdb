...
本页定义 Aiao 各包的版本约定、公开 API 范围、废弃周期与破坏性变更审查流程。它同时是仓库内 [`requirements/versioning-policy.md`](https://github.com/aiao-io/aiao/blob/main/requirements/versioning-policy.md) 的对外呈现。
