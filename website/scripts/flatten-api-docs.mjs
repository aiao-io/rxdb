...
const apiPackageDescriptions = {
  ...
  'rxdb-plugin-tree': '树形结构实体、仓储与增量 merge 插件',
  'rxdb-plugin-tree-angular': '树插件 Angular 集成（四个树查询函数）',
  'rxdb-plugin-tree-react': '树插件 React 集成（四个树查询 hook）',
  'rxdb-plugin-tree-vue': '树插件 Vue 集成（四个树查询 composable）',
