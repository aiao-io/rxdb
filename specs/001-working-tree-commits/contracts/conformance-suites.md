...
| B-4 未物化分支            | 切换到未物化分支 → `branch_not_materialized`，不自动物化                                                                                                                                                                          | FR-047         |
...
| B-7 createBranch          | 从源分支 HEAD 派生 `branch_baseline` 并写 `rxdb_commit_branch_ref`；新分支工作树与缓存区为空，不继承源分支未提交内容                                                                                                              | FR-051         |
