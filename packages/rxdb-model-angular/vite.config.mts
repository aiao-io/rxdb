...
export default defineConfig(({ mode }) => ({
  ...
  cacheDir: '../../node_modules/.vite/packages/rxdb-model-angular',
  plugins: [
  ...
  test: {
    ...
    outputFile: {
      junit: '../../coverage/packages/rxdb-model-angular/junit.xml'
    },
    coverage: {
