...
export default defineConfig(() => ({
  ...
  cacheDir: '../../node_modules/.vite/packages/rxdb-plugin-tree-react',
  plugins: [
    react(),
    dts({
      entryRoot: 'src',
    ...
    ...(process.env.CI === 'true' && process.env.CODECOV_TOKEN ?
      [
        codecovVitePlugin({
          ...
          telemetry: false,
          bundleName: 'rxdb-plugin-tree-react',
  ...
  test: {
    ...
    coverage: {
      enabled: true,
      reportsDirectory: '../../coverage/packages/rxdb-plugin-tree-react',
