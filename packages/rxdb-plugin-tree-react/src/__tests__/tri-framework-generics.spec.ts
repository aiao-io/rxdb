/**
 * 树 hooks 的泛型契约（RAN-014）—— React 侧。
 *
 * @remarks
 * 断言全部在**编译期**成立：`@ts-expect-error` 由 `nx typecheck rxdb-plugin-tree-react` 校验 ——
 ...
 * - `packages/rxdb-plugin-tree-angular/src/__tests__/tri-framework-generics.spec.ts`
 */
