...
import type { FieldMetadata, UIRule } from '../../../query-builder/models/query-builder-state.js';
import type { ValidationRule } from '../../../query-builder/models/validation.interface.js';
import { ValidationService, createValidationService } from '../../../query-builder/services/validation.service.js';
