import { ENTITY_STATIC_TYPES, QueryTask, type RxDBEntityLocalCreatedEventData } from '@aiao/rxdb';
import { collectEmissions, createHarnessQueryTask, type HarnessTaskOptions } from '@aiao/rxdb/testing';
import { of } from 'rxjs';
