...
export default defineConfig(() => ({
  ...
  cacheDir: '../../node_modules/.vite/packages/rxdb-plugin-history',
  plugins: [
    dts({
      entryRoot: 'src',
    ...
    ...(process.env.CI === 'true' && process.env.CODECOV_TOKEN ?
      [
        codecovVitePlugin({
          ...
          telemetry: false,
          bundleName: 'rxdb-plugin-history',
  ...
  test: {
    ...
    outputFile: {
      junit: '../../coverage/packages/rxdb-plugin-history/junit.xml'
    },
    coverage: {
      enabled: true,
      reportsDirectory: '../../coverage/packages/rxdb-plugin-history',
