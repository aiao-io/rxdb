 ...
 *
 * @remarks
 * **内部契约，不进公开 api-baseline。** 意图是「我知道我在重写业务投影，并且我会自己维护工作树」
...
import { classifyWriteEntrance, type WriteEntrance } from './write-entry-matrix.js';
 ...
 * 里迟早有一份是旧的。要这个答案就调 {@link producesWorkingTreeEntry}。
 */
