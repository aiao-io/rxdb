...
三 OS 矩阵跑绿收掉 US-505 / US-208 后，仓库还剩 **9 条**未关闭故事（2 In Progress + 1 In Review + 6 Backlog，
...
| 顺序                                                                     | 解锁自     | 说明                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ------------------------------------------------------------------------ | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| US-904 阶段 D                                                            | 线 E       | C2 已交付，阶段 D 已开工并基本落地：AC#48（snapshot wire 复用 `files.list`）、AC#50（preload 校验层）、AC#53（Electron conformance driver）已关闭；AC#52（真实全链路 E2E：`devtools-restart-persistence.spec.ts`）已于 2026-09-03 真机跑通，「本机不可验证」的判断作废。AC#45/46/47/49/51 的 provider/单测侧已关，**只剩它们的 E2E 侧**——不再卡环境，从 AC#52 那套已跑通的驱动出发即可（注意：自定义 `app:` scheme 拿不到扩展 host permission，E2E 必须走应用的 `--serve` http renderer）。C 阶段残留 AC#34/#38/#39/#42 待人工浏览器回归 / 跨版本实证                                                                                                                                                                                                                                                                                                                                   |
...
| [US-906](stories/future/US-906-electron-devtools-developer-path.md)            | 前置（US-904 阶段 D 的四段 relay 与 `--serve` 路径）已交付，无硬阻塞。补的是开发者体验缺口：桌面端面板今天只有 E2E 跑得起来，开发者手上没有带静态 `host_permissions` 的扩展产物 |
