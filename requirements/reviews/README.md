...
| `next-0912-branch-review.md`                        | next-0912 分支相对 main 的 epic-006「工作树 + 提交历史」评审（max 强度）             | 13 条次要 + 约 30 条清理 |
...
> 最近一次整分支评审：2026-09-16，见 [`next-0915-branch-review.md`](./next-0915-branch-review.md)
> 与 [`next-0912-branch-review.md`](./next-0912-branch-review.md)（后者 2026-09-17 复核重对基线）。
