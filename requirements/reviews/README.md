...
| `next-0912-branch-review.md`                        | next-0912 分支相对 main 的 epic-006「工作树 + 提交历史」评审（2026-09-18 复核）      | 4 条 P1 + 4 条 P2 + 11 条次要 + 清理项 |
...
> 最近一次整分支复核：2026-09-18，见 [`next-0912-branch-review.md`](./next-0912-branch-review.md)（当前不建议合并）；
