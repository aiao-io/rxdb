...
- 🚧 [US-905 Tauri DevTools 调试窗口](stories/future/US-905-tauri-native-devtools.md) — 阶段 1（AC#1～#8）**5 ✅ / 3 ⚠️**：AC#1/#3/#4/#5/#8 已由真实双窗口 harness 关闭；⚠️ 的 #2 #6 #7 差的不是 harness，而是一次 owner 边界决定（往产品 demo 里放多少 dev-only 测试脚手架）或阶段 2 的真实 provider。阶段 2（AC#9～#17）**已开工**（C1～C3 + C4 前三片已落地，AC#9/#12/#13/#14/#15/#17 转 ⚠️，**一条都还没关**），前置 US-210 + US-505 均已 Done
